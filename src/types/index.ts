...
export const STEPS: readonly StepDefinition[] = [
  ...
  },
  {
    ...
    type: 'ai-work',
    icon: '📝',
    description: '시장조사 결과를 바탕으로 브리프를 작성합니다.',
  },
  {
    id: 3,
    name: '브리프 확정',
    ...
    lockable: true,
    icon: '🔒',
    description: '브리프를 확정합니다. 확정 후 PDF 내보내기가 가능합니다.',
  },
  {
    id: 4,
    name: '기획안 작성',
    ...
    type: 'ai-work',
    icon: '📋',
    description: '확정된 브리프를 기반으로 기획안을 작성합니다.',
  },
  {
    id: 5,
    name: '기획안 확정',
    ...
    lockable: true,
    icon: '🔒',
    description: '기획안을 확정합니다. 확정 후 PDF 내보내기가 가능합니다.',
  },
  {
    id: 6,
    name: '촬영콘티 가이드 작성',
